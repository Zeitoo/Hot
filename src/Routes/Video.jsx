	...
	return (
		<div className="mt-0 md:mt-5">
			...
			<div className="relative w-full mt-0 md:mt-5 max-w-3xl mx-auto p-5 md:p-0">
				<div>
					<p className="title font-medium">{videoDat.title}</p>
					<p>
						{videoDat.description}
						<span className="text-green-900">{
                            videoDat.storage}</span> collection
						Price: <span className="text-red-800">$ {videoDat.price}</span>
					</p>
				</div>
